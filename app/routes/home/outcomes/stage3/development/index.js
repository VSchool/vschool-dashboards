...
export default function AllStage3Page() {
    ...
    let medianSalary = getMedian(filteredRecords.filter(fields => fields['Compensation Rate'] && fields['Compensation Unit'] === 'Annual' && fields['Course Subject'][0] === 'FSJS'), 'Compensation Rate');

    return (
        <main>
            <h1>Stage 3 Development Records</h1>
            <div className="flex">
            ...
            <br />
            <div>
                <p>Total Hired: {filteredRecords.filter(fields => fields['Course Subject'][0] === 'FSJS').length}</p>
