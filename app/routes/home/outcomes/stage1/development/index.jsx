...
export default function AllStage1Page() {
    ...
    const medianComp = filteredProgress.filter(fields => fields['Level Number'] == 8 && fields['Status'] === 'Completed' && fields['Actual End Date'] && !isNaN(fields['Course Completed in Days']) && fields['Course Completed in Days'] > 0 && (fields['Course Subject'] && fields['Course Subject'][0] === 'FSJS') )

    //////// GET MEDIAN DAYS //////////
    const medianDays = filteredProgress.filter(fields => fields['Level Number'] > 0 && fields['Level Number'] < 7 && !isNaN(fields['Days in Level']) && fields['Days in Level'] > 0 && (fields['Course Subject'] && fields['Course Subject'][0] === 'FSJS'))
