...
export default function AllStage1Page() {
    ...
    return (
		...
		<br />
        <div>
            <p>Total Student Records: {filteredStage1.length}</p>
            <p>Active: {filteredStage1.filter(fields => fields["Simple Status"] === "In Progress").length}</p>
            ...
            <p>Started: {filteredStage1.filter(fields => fields["Simple Status"] === "In Progress").length}</p> 
            <p>Paused: {filteredStage1.filter(fields => fields["Simple Status"] === "Paused").length}</p>
